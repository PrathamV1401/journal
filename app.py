...
with st.sidebar:
    ...
    if selected_account_name:
        ...
        with st.form("trade_form", clear_on_submit=True):
            ...
            s_risked = st.number_input(f"Risked Amount ({acc_currency})", min_value=0.0, step=0.01, value=0.0, help="Amount risked on this trade for R:R calculations")
            ...
            if submitted:
                ...
                if not s_symbol.strip():
                    ...
                    db.add_trade(
                        account_options[selected_account_name], s_symbol.upper(), s_direction, s_date, s_qty, s_pnl, s_risked, status,
